...
--
-- Host: localhost
-- Generation Time: Oct 25, 2017 at 08:07 AM
...
INSERT INTO `tbl_schedule` (`id`, `name`, `location`, `date`, `area`, `street_address`) VALUES
...
INSERT INTO `tbl_upload` (`image_id`, `file_name`, `price`, `description`, `waste_type`) VALUES
...
INSERT INTO `user` (`user_id`, `user_name`, `user_email`, `user_password`, `gender`, `user_age`, `user_mobile`, `user_type`) VALUES
